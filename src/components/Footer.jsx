      ...
      <div className="w-full max-w-[1110px] mx-auto text-white flex flex-col items-center gap-12 text-center md:grid md:grid-cols-[auto_1fr_auto] md:grid-rows-[auto_auto] md:items-start md:text-left">
        <div className="flex flex-col items-center gap-8 md:items-start md:row-span-2 md:justify-between md:min-h-[127px]">
            ...
            <ul className="flex flex-row flex-wrap justify-center gap-3 uppercase text-[14px] font-bold list-none md:justify-start">
              ...
              <li>
                <Link to="https://www.youtube.com" className="text-white hover:text-gray-400 transition-colors">
              ...
              <li>
                <Link to="https://www.twitter.com" className="text-white hover:text-gray-400 transition-colors">
              ...
              <li>
                <Link to="https://www.pinterest.com" className="text-white hover:text-gray-400 transition-colors">
              ...
              <li>
                <Link to="https://www.instagram.com" className="text-white hover:text-gray-400 ">
        ...
        <ul className="flex flex-col gap-4 uppercase text-[12px] tracking-[0.15em] font-bold list-none md:justify-self-start md:self-center">
          <li>
            <NavLink to="/" className="text-white hover:text-gray-400 transition-colors">
              Home
            </NavLink>
          </li>
          <li>
            <NavLink to="/stories" className="text-white hover:text-gray-400 transition-colors">
              Stories
            </NavLink>
          </li>
          <li>
            <NavLink to="/features" className="text-white hover:text-gray-400 transition-colors">
              Features
            </NavLink>
          </li>
          <li>
            <NavLink to="/pricing" className="text-white hover:text-gray-400 transition-colors">
              Pricing
            </NavLink>
          </li>
        </ul>
        <div className='w-full max-w-[255px] flex flex-col items-center gap-20 md:items-end md:justify-self-end'>
                ...
                <p className="w-full text-[15px] font-normal text-[var(--color-neutral-200)] md:col-[3] md:row-[2] md:text-right">
