...
export default function Navbar() {
  ...
  return (
    <header className="relative z-50 w-full bg-white">
      <nav className="w-full max-w-[1440px] min-h-[72px] mx-auto px-6 py-4 flex items-center justify-between md:px-10 xl:px-[165px]">
        ...
        <ul className="hidden md:flex items-center gap-9 uppercase text-[12px] tracking-[0.15em] font-bold list-none">
          <li>
            <NavLink to="/stories" className="text-black hover:text-gray-500 transition-colors">
              Stories
            </NavLink>
          </li>
          <li>
            <NavLink to="/features" className="text-black hover:text-gray-500 transition-colors">
              Features
            </NavLink>
          </li>
          <li>
            <NavLink to="/pricing" className="text-black hover:text-gray-500 transition-colors">
              Pricing
            </NavLink>
          </li>
        </ul>
        ...
        <a
          href="#"
          className="hidden md:inline-flex px-6 py-3 bg-black text-white text-[12px] tracking-[0.15em] font-bold uppercase hover:bg-gray-700 transition-colors"
        >
          Get an invite
        </a>
        ...
        >
          <img
            src={isMenuOpen ? '/assets/shared/mobile/close.svg' : '/assets/shared/mobile/menu.svg'}
            alt=""
            aria-hidden="true"
            className="h-4 w-5"
          />
      ...
      {isMenuOpen ? (
        <div className="absolute inset-x-0 top-full bg-black/50 px-6 pb-6 md:hidden">
          <div className="mx-auto mt-4 w-full max-w-[327px] bg-white px-8 py-8 shadow-lg">
            <ul className="flex flex-col items-center gap-5 border-b border-black/25 pb-5 uppercase text-[15px] tracking-[0.15em] font-bold list-none">
              <li>
                <NavLink to="/stories" onClick={closeMenu} className="text-black hover:text-gray-500 transition-colors">
                  Stories
                </NavLink>
              </li>
              <li>
                <NavLink to="/features" onClick={closeMenu} className="text-black hover:text-gray-500 transition-colors">
                  Features
                </NavLink>
              </li>
              <li>
                <NavLink to="/pricing" onClick={closeMenu} className="text-black hover:text-gray-500 transition-colors">
                  Pricing
                </NavLink>
              </li>
            </ul>
            <a
              href="#"
              className="mt-5 inline-flex w-full items-center justify-center bg-black px-6 py-4 text-white text-[12px] tracking-[0.15em] font-bold uppercase hover:bg-gray-700 transition-colors"
              onClick={closeMenu}
            >
              Get an invite
            </a>
